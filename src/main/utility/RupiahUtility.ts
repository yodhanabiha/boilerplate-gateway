class Rupiah {
  ...
  public format(params : {prefix?: string, suffix?: string, separator?: string} | null) {

    if(params){
        if(params.prefix != undefined) this.prefix = params.prefix;
        if(params.suffix != undefined) this.suffix = params.suffix;
        if(params.separator != undefined) this.separator = params.separator;
    }
